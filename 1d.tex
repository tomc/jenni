...
\begin{bidtable}{\orauction{1d}}
  ...
  \cl2  &  10+ HCP, 5+ \ccc, F1 \\
  \di2  &  10+ HCP, 5+ \ddd, F1 \\
  \he2 & \rem{Mar2022} Nat Inv  \\
  \sp2 & \rem{Mar2022} Nat Inv \\
...
\begin{bidtable}{\orauction{1d,1h}}
  ...
  \he2 & Simple raise, usually (always?) 4 \hhh. 10--13 HCP if balanced. \\
...
\begin{bidtable}{\orauction{1d,1s}}
  ...
  \sp2 & Simple raise, usually 4 \sss. 10--13 HCP if balanced. \\
...
Over \sp2, 2NT asks LMHN shortness.  None is rare, so boosted to be the final step.  Most balanced hands with long diamonds and enough to GF will just bid 3NT.
...
4m is South African Texas / Namyats:  \cl4=\hhh, \di4=\sss.  Opener may bid the step in between to express slam interest.  Over sign off, new suits by Responder are exclusion (like most Texas xfers).   
