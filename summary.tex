...
''TaJ Precision'' 
Strong Club system with 0+ \di1.  No "Precision" \di2 opener.  All 10 HCP hands opened NV, allowed to pass a 10 Vul. Lighter openers possible with shape.  

\section{Opening Bid Summary}

\begin{description}
	\item[\cl1] Strong, Forcing, Artificial.  Typically 16+ HCP unbal or 17+ bal
	\item[\di1] 0+ \ddd, 10-15.  Denies 5 card major unless 6+ \ddd.  \third seat is 2+ \ddd
	\item[\he1] 5+ \hhh, 10-15, can be 4 \third/\fourth
	\item[\sp1] 5+ \sss, 10-15, can be 4 \third/\fourth
